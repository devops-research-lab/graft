...
// 	protoc        v5.29.3
// source: tensorflow/serving/apis/internal/serialized_input.proto
...
func (x *SerializedInput) GetKind() isSerializedInput_Kind {
	if x != nil {
		return x.Kind
	}
	return nil
...
func (x *SerializedInput) GetExampleList() *SerializedExampleList {
	if x != nil {
		if x, ok := x.Kind.(*SerializedInput_ExampleList); ok {
...
func (x *SerializedInput) GetExampleListWithContext() *SerializedExampleListWithContext {
	if x != nil {
		if x, ok := x.Kind.(*SerializedInput_ExampleListWithContext); ok {
...
var file_tensorflow_serving_apis_internal_serialized_input_proto_rawDesc = string([]byte{
	0x0a, 0x37, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72,
	...
	0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x42, 0x52, 0x5a, 0x4d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	...
	0x2f, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x5f, 0x67,
...
var (
	...
	file_tensorflow_serving_apis_internal_serialized_input_proto_rawDescData []byte
)
...
func file_tensorflow_serving_apis_internal_serialized_input_proto_rawDescGZIP() []byte {
	file_tensorflow_serving_apis_internal_serialized_input_proto_rawDescOnce.Do(func() {
		file_tensorflow_serving_apis_internal_serialized_input_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_serving_apis_internal_serialized_input_proto_rawDesc), len(file_tensorflow_serving_apis_internal_serialized_input_proto_rawDesc)))
	})
...
var file_tensorflow_serving_apis_internal_serialized_input_proto_goTypes = []any{
...
func file_tensorflow_serving_apis_internal_serialized_input_proto_init() {
	...
	file_tensorflow_serving_apis_internal_serialized_input_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_serving_apis_internal_serialized_input_proto_rawDesc), len(file_tensorflow_serving_apis_internal_serialized_input_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
