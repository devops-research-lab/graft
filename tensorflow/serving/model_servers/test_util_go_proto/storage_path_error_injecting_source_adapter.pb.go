...
// 	protoc        v5.29.3
// source: tensorflow/serving/model_servers/test_util/storage_path_error_injecting_source_adapter.proto

package test_util_go_proto
...
var file_tensorflow_serving_model_servers_test_util_storage_path_error_injecting_source_adapter_proto_rawDesc = string([]byte{
	0x0a, 0x5c, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72,
	...
	0x2f, 0x67, 0x6f, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x2f, 0x6d, 0x6f, 0x64, 0x65,
	0x6c, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x75,
	0x74, 0x69, 0x6c, 0x5f, 0x67, 0x6f, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_tensorflow_serving_model_servers_test_util_storage_path_error_injecting_source_adapter_proto_rawDescOnce sync.Once
	file_tensorflow_serving_model_servers_test_util_storage_path_error_injecting_source_adapter_proto_rawDescData []byte
)
...
func file_tensorflow_serving_model_servers_test_util_storage_path_error_injecting_source_adapter_proto_rawDescGZIP() []byte {
	file_tensorflow_serving_model_servers_test_util_storage_path_error_injecting_source_adapter_proto_rawDescOnce.Do(func() {
		file_tensorflow_serving_model_servers_test_util_storage_path_error_injecting_source_adapter_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_serving_model_servers_test_util_storage_path_error_injecting_source_adapter_proto_rawDesc), len(file_tensorflow_serving_model_servers_test_util_storage_path_error_injecting_source_adapter_proto_rawDesc)))
	})
...
var file_tensorflow_serving_model_servers_test_util_storage_path_error_injecting_source_adapter_proto_goTypes = []any{
...
func file_tensorflow_serving_model_servers_test_util_storage_path_error_injecting_source_adapter_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_serving_model_servers_test_util_storage_path_error_injecting_source_adapter_proto_rawDesc), len(file_tensorflow_serving_model_servers_test_util_storage_path_error_injecting_source_adapter_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
