...
// 	protoc        v5.29.3
// source: tensorflow/serving/config/monitoring_config.proto
...
var file_tensorflow_serving_config_monitoring_config_proto_rawDesc = string([]byte{
	0x0a, 0x31, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72,
	...
	0x6f, 0x6d, 0x65, 0x74, 0x68, 0x65, 0x75, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x4b,
	0x5a, 0x46, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x65, 0x6e,
	...
	0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f,
...
var (
	...
	file_tensorflow_serving_config_monitoring_config_proto_rawDescData []byte
)
...
func file_tensorflow_serving_config_monitoring_config_proto_rawDescGZIP() []byte {
	file_tensorflow_serving_config_monitoring_config_proto_rawDescOnce.Do(func() {
		file_tensorflow_serving_config_monitoring_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_serving_config_monitoring_config_proto_rawDesc), len(file_tensorflow_serving_config_monitoring_config_proto_rawDesc)))
	})
...
var file_tensorflow_serving_config_monitoring_config_proto_goTypes = []any{
...
func file_tensorflow_serving_config_monitoring_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_serving_config_monitoring_config_proto_rawDesc), len(file_tensorflow_serving_config_monitoring_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
