...
// 	protoc        v5.29.3
// source: tensorflow/serving/config/model_server_config.proto
...
const (
	// Deprecated: Marked as deprecated in tensorflow/serving/config/model_server_config.proto.
...
type ModelConfig struct {
	...
	VersionLabels map[string]int64 `protobuf:"bytes,8,rep,name=version_labels,json=versionLabels,proto3" json:"version_labels,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
func (x *ModelServerConfig) GetConfig() isModelServerConfig_Config {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *ModelServerConfig) GetModelConfigList() *ModelConfigList {
	if x != nil {
		if x, ok := x.Config.(*ModelServerConfig_ModelConfigList); ok {
...
func (x *ModelServerConfig) GetCustomModelConfig() *anypb.Any {
	if x != nil {
		if x, ok := x.Config.(*ModelServerConfig_CustomModelConfig); ok {
...
var file_tensorflow_serving_config_model_server_config_proto_rawDesc = string([]byte{
	0x0a, 0x33, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72,
	...
	0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2f,
	...
	0x77, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	0x45, 0x52, 0x10, 0x02, 0x1a, 0x02, 0x08, 0x01, 0x42, 0x4b, 0x5a, 0x46, 0x67, 0x69, 0x74, 0x68,
	...
	0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x67, 0x6f, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x6e, 0x67, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f, 0x67, 0x6f, 0x5f, 0x70, 0x72, 0x6f,
...
var (
	...
	file_tensorflow_serving_config_model_server_config_proto_rawDescData []byte
)
...
func file_tensorflow_serving_config_model_server_config_proto_rawDescGZIP() []byte {
	file_tensorflow_serving_config_model_server_config_proto_rawDescOnce.Do(func() {
		file_tensorflow_serving_config_model_server_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_serving_config_model_server_config_proto_rawDesc), len(file_tensorflow_serving_config_model_server_config_proto_rawDesc)))
	})
...
var file_tensorflow_serving_config_model_server_config_proto_goTypes = []any{
...
func file_tensorflow_serving_config_model_server_config_proto_init() {
	...
	file_tensorflow_serving_config_model_server_config_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_serving_config_model_server_config_proto_rawDesc), len(file_tensorflow_serving_config_model_server_config_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
