...
// 	protoc        v5.29.3
// source: tensorflow/serving/config/platform_config.proto
...
type PlatformConfigMap struct {
	...
	PlatformConfigs map[string]*PlatformConfig `protobuf:"bytes,1,rep,name=platform_configs,json=platformConfigs,proto3" json:"platform_configs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
var file_tensorflow_serving_config_platform_config_proto_rawDesc = string([]byte{
	0x0a, 0x2f, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72,
	...
	0x01, 0x42, 0x4b, 0x5a, 0x46, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
	...
	0x2f, 0x67, 0x6f, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x2f, 0x63, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x5f, 0x67, 0x6f, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0xf8, 0x01, 0x01, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_tensorflow_serving_config_platform_config_proto_rawDescOnce sync.Once
	file_tensorflow_serving_config_platform_config_proto_rawDescData []byte
)
...
func file_tensorflow_serving_config_platform_config_proto_rawDescGZIP() []byte {
	file_tensorflow_serving_config_platform_config_proto_rawDescOnce.Do(func() {
		file_tensorflow_serving_config_platform_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_serving_config_platform_config_proto_rawDesc), len(file_tensorflow_serving_config_platform_config_proto_rawDesc)))
	})
...
var file_tensorflow_serving_config_platform_config_proto_goTypes = []any{
...
func file_tensorflow_serving_config_platform_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_serving_config_platform_config_proto_rawDesc), len(file_tensorflow_serving_config_platform_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
