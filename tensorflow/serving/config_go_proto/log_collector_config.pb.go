...
// 	protoc        v5.29.3
// source: tensorflow/serving/config/log_collector_config.proto
...
var file_tensorflow_serving_config_log_collector_config_proto_rawDesc = string([]byte{
	...
	0x69, 0x6c, 0x65, 0x6e, 0x61, 0x6d, 0x65, 0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x42, 0x4b, 0x5a,
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f, 0x67,
...
var (
	...
	file_tensorflow_serving_config_log_collector_config_proto_rawDescData []byte
)
...
func file_tensorflow_serving_config_log_collector_config_proto_rawDescGZIP() []byte {
	file_tensorflow_serving_config_log_collector_config_proto_rawDescOnce.Do(func() {
		file_tensorflow_serving_config_log_collector_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_serving_config_log_collector_config_proto_rawDesc), len(file_tensorflow_serving_config_log_collector_config_proto_rawDesc)))
	})
...
var file_tensorflow_serving_config_log_collector_config_proto_goTypes = []any{
...
func file_tensorflow_serving_config_log_collector_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_serving_config_log_collector_config_proto_rawDesc), len(file_tensorflow_serving_config_log_collector_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
