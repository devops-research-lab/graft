...
// 	protoc        v5.29.3
// source: tensorflow/serving/config/file_system_storage_path_source.proto
...
type FileSystemStoragePathSourceConfig struct {
	...
	//
	// Deprecated: Marked as deprecated in tensorflow/serving/config/file_system_storage_path_source.proto.
...
func (x *FileSystemStoragePathSourceConfig_ServableVersionPolicy) GetPolicyChoice() isFileSystemStoragePathSourceConfig_ServableVersionPolicy_PolicyChoice {
	if x != nil {
...
func (x *FileSystemStoragePathSourceConfig_ServableVersionPolicy) GetLatest() *FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest {
	if x != nil {
		if x, ok := x.PolicyChoice.(*FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest_); ok {
			return x.Latest
		}
	}
	return nil
...
func (x *FileSystemStoragePathSourceConfig_ServableVersionPolicy) GetAll() *FileSystemStoragePathSourceConfig_ServableVersionPolicy_All {
	if x != nil {
		if x, ok := x.PolicyChoice.(*FileSystemStoragePathSourceConfig_ServableVersionPolicy_All_); ok {
			return x.All
		}
	}
	return nil
...
func (x *FileSystemStoragePathSourceConfig_ServableVersionPolicy) GetSpecific() *FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific {
	if x != nil {
		if x, ok := x.PolicyChoice.(*FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific_); ok {
			return x.Specific
		}
	}
	return nil
...
var file_tensorflow_serving_config_file_system_storage_path_source_proto_rawDesc = string([]byte{
	0x0a, 0x3f, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72,
	...
	0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x42, 0x48, 0x5a, 0x46, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	...
	0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x67, 0x6f, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67,
...
var (
	...
	file_tensorflow_serving_config_file_system_storage_path_source_proto_rawDescData []byte
)
...
func file_tensorflow_serving_config_file_system_storage_path_source_proto_rawDescGZIP() []byte {
	file_tensorflow_serving_config_file_system_storage_path_source_proto_rawDescOnce.Do(func() {
		file_tensorflow_serving_config_file_system_storage_path_source_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_serving_config_file_system_storage_path_source_proto_rawDesc), len(file_tensorflow_serving_config_file_system_storage_path_source_proto_rawDesc)))
	})
...
var file_tensorflow_serving_config_file_system_storage_path_source_proto_goTypes = []any{
...
func file_tensorflow_serving_config_file_system_storage_path_source_proto_init() {
	...
	file_tensorflow_serving_config_file_system_storage_path_source_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_serving_config_file_system_storage_path_source_proto_rawDesc), len(file_tensorflow_serving_config_file_system_storage_path_source_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
