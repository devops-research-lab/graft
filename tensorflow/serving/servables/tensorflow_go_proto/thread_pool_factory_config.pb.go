...
// 	protoc        v5.29.3
// source: tensorflow/serving/servables/tensorflow/thread_pool_factory_config.proto
...
var file_tensorflow_serving_servables_tensorflow_thread_pool_factory_config_proto_rawDesc = string([]byte{
	...
	0x79, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x59, 0x5a, 0x54, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x67, 0x6f, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0xf8,
...
var (
	...
	file_tensorflow_serving_servables_tensorflow_thread_pool_factory_config_proto_rawDescData []byte
)
...
func file_tensorflow_serving_servables_tensorflow_thread_pool_factory_config_proto_rawDescGZIP() []byte {
	file_tensorflow_serving_servables_tensorflow_thread_pool_factory_config_proto_rawDescOnce.Do(func() {
		file_tensorflow_serving_servables_tensorflow_thread_pool_factory_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_serving_servables_tensorflow_thread_pool_factory_config_proto_rawDesc), len(file_tensorflow_serving_servables_tensorflow_thread_pool_factory_config_proto_rawDesc)))
	})
...
var file_tensorflow_serving_servables_tensorflow_thread_pool_factory_config_proto_goTypes = []any{
...
func file_tensorflow_serving_servables_tensorflow_thread_pool_factory_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_serving_servables_tensorflow_thread_pool_factory_config_proto_rawDesc), len(file_tensorflow_serving_servables_tensorflow_thread_pool_factory_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
