...
// 	protoc        v5.29.3
// source: tensorflow/serving/session_bundle/oss/manifest.proto

package oss_go_proto
...
type Signatures struct {
	...
	NamedSignatures map[string]*Signature `protobuf:"bytes,2,rep,name=named_signatures,json=namedSignatures,proto3" json:"named_signatures,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *Signature) GetType() isSignature_Type {
	if x != nil {
		return x.Type
	}
	return nil
...
func (x *Signature) GetRegressionSignature() *RegressionSignature {
	if x != nil {
		if x, ok := x.Type.(*Signature_RegressionSignature); ok {
...
func (x *Signature) GetClassificationSignature() *ClassificationSignature {
	if x != nil {
		if x, ok := x.Type.(*Signature_ClassificationSignature); ok {
...
func (x *Signature) GetGenericSignature() *GenericSignature {
	if x != nil {
		if x, ok := x.Type.(*Signature_GenericSignature); ok {
...
type GenericSignature struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	Map           map[string]*TensorBinding `protobuf:"bytes,1,rep,name=map,proto3" json:"map,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_tensorflow_serving_session_bundle_oss_manifest_proto_rawDesc = string([]byte{
	0x0a, 0x34, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x54, 0x5a, 0x52, 0x67, 0x69,
	...
	0x76, 0x69, 0x6e, 0x67, 0x2f, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x62, 0x75, 0x6e,
	0x64, 0x6c, 0x65, 0x2f, 0x6f, 0x73, 0x73, 0x5f, 0x67, 0x6f, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_tensorflow_serving_session_bundle_oss_manifest_proto_rawDescOnce sync.Once
	file_tensorflow_serving_session_bundle_oss_manifest_proto_rawDescData []byte
)
...
func file_tensorflow_serving_session_bundle_oss_manifest_proto_rawDescGZIP() []byte {
	file_tensorflow_serving_session_bundle_oss_manifest_proto_rawDescOnce.Do(func() {
		file_tensorflow_serving_session_bundle_oss_manifest_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_serving_session_bundle_oss_manifest_proto_rawDesc), len(file_tensorflow_serving_session_bundle_oss_manifest_proto_rawDesc)))
	})
...
var file_tensorflow_serving_session_bundle_oss_manifest_proto_goTypes = []any{
...
func file_tensorflow_serving_session_bundle_oss_manifest_proto_init() {
	...
	file_tensorflow_serving_session_bundle_oss_manifest_proto_msgTypes[3].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_serving_session_bundle_oss_manifest_proto_rawDesc), len(file_tensorflow_serving_session_bundle_oss_manifest_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
