...
// 	protoc        v5.29.3
// source: tensorflow/serving/apis/status.proto

package apis_go_proto

import (
	_ "github.com/wamuir/graft/tensorflow/core/protobuf/for_core_protos_go_proto"
...
var file_tensorflow_serving_apis_status_proto_rawDesc = string([]byte{
	0x0a, 0x24, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72,
	...
	0x61, 0x67, 0x65, 0x42, 0x49, 0x5a, 0x44, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var (
	...
	file_tensorflow_serving_apis_status_proto_rawDescData []byte
)
...
func file_tensorflow_serving_apis_status_proto_rawDescGZIP() []byte {
	file_tensorflow_serving_apis_status_proto_rawDescOnce.Do(func() {
		file_tensorflow_serving_apis_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_serving_apis_status_proto_rawDesc), len(file_tensorflow_serving_apis_status_proto_rawDesc)))
	})
...
var file_tensorflow_serving_apis_status_proto_goTypes = []any{
...
func file_tensorflow_serving_apis_status_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_serving_apis_status_proto_rawDesc), len(file_tensorflow_serving_apis_status_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
