...
// 	protoc        v5.29.3
// source: tensorflow/serving/apis/input.proto

package apis_go_proto

import (
	example_protos_go_proto "github.com/wamuir/graft/tensorflow/core/example/example_protos_go_proto"
...
func (x *Input) GetKind() isInput_Kind {
	if x != nil {
		return x.Kind
	}
	return nil
...
func (x *Input) GetExampleList() *ExampleList {
	if x != nil {
		if x, ok := x.Kind.(*Input_ExampleList); ok {
...
func (x *Input) GetExampleListWithContext() *ExampleListWithContext {
	if x != nil {
		if x, ok := x.Kind.(*Input_ExampleListWithContext); ok {
...
var file_tensorflow_serving_apis_input_proto_rawDesc = string([]byte{
	0x0a, 0x23, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72,
...
var (
	...
	file_tensorflow_serving_apis_input_proto_rawDescData []byte
)
...
func file_tensorflow_serving_apis_input_proto_rawDescGZIP() []byte {
	file_tensorflow_serving_apis_input_proto_rawDescOnce.Do(func() {
		file_tensorflow_serving_apis_input_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_serving_apis_input_proto_rawDesc), len(file_tensorflow_serving_apis_input_proto_rawDesc)))
	})
...
var file_tensorflow_serving_apis_input_proto_goTypes = []any{
...
func file_tensorflow_serving_apis_input_proto_init() {
	...
	file_tensorflow_serving_apis_input_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_serving_apis_input_proto_rawDesc), len(file_tensorflow_serving_apis_input_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
