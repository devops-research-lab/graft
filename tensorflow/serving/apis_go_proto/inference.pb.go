...
// 	protoc        v5.29.3
// source: tensorflow/serving/apis/inference.proto
...
func (x *InferenceResult) GetClassificationResult() *ClassificationResult {
	if x != nil {
		if x, ok := x.Result.(*InferenceResult_ClassificationResult); ok {
...
func (x *InferenceResult) GetRegressionResult() *RegressionResult {
	if x != nil {
		if x, ok := x.Result.(*InferenceResult_RegressionResult); ok {
...
var file_tensorflow_serving_apis_inference_proto_rawDesc = string([]byte{
	0x0a, 0x27, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72,
	...
	0x1a, 0x23, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72,
	...
	0x77, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x72,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x42, 0x49,
	0x5a, 0x44, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x65, 0x6e,
	...
	0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x5f, 0x67, 0x6f,
...
var (
	...
	file_tensorflow_serving_apis_inference_proto_rawDescData []byte
)
...
func file_tensorflow_serving_apis_inference_proto_rawDescGZIP() []byte {
	file_tensorflow_serving_apis_inference_proto_rawDescOnce.Do(func() {
		file_tensorflow_serving_apis_inference_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_serving_apis_inference_proto_rawDesc), len(file_tensorflow_serving_apis_inference_proto_rawDesc)))
	})
...
var file_tensorflow_serving_apis_inference_proto_goTypes = []any{
...
func file_tensorflow_serving_apis_inference_proto_init() {
	...
	file_tensorflow_serving_apis_inference_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_serving_apis_inference_proto_rawDesc), len(file_tensorflow_serving_apis_inference_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
