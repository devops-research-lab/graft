...
// 	protoc        v5.29.3
// source: tensorflow/serving/apis/get_model_metadata.proto
...
type SignatureDefMap struct {
	...
	SignatureDef  map[string]*for_core_protos_go_proto.SignatureDef `protobuf:"bytes,1,rep,name=signature_def,json=signatureDef,proto3" json:"signature_def,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
var file_tensorflow_serving_apis_get_model_metadata_proto_rawDesc = string([]byte{
	0x0a, 0x30, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72,
	...
	0x38, 0x01, 0x42, 0x49, 0x5a, 0x44, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
...
var (
	...
	file_tensorflow_serving_apis_get_model_metadata_proto_rawDescData []byte
)
...
func file_tensorflow_serving_apis_get_model_metadata_proto_rawDescGZIP() []byte {
	file_tensorflow_serving_apis_get_model_metadata_proto_rawDescOnce.Do(func() {
		file_tensorflow_serving_apis_get_model_metadata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_serving_apis_get_model_metadata_proto_rawDesc), len(file_tensorflow_serving_apis_get_model_metadata_proto_rawDesc)))
	})
...
var file_tensorflow_serving_apis_get_model_metadata_proto_goTypes = []any{
...
func file_tensorflow_serving_apis_get_model_metadata_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_serving_apis_get_model_metadata_proto_rawDesc), len(file_tensorflow_serving_apis_get_model_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
