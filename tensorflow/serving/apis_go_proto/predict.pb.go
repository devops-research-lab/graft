...
func file_tensorflow_serving_apis_predict_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tensorflow_serving_apis_predict_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_tensorflow_serving_apis_predict_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
