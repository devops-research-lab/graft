...
func file_tensorflow_serving_apis_predict_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tensorflow_serving_apis_predict_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_tensorflow_serving_apis_predict_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_tensorflow_serving_apis_predict_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_tensorflow_serving_apis_predict_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*PredictRequest_RequestOptions); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
