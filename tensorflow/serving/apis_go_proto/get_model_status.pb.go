...
func file_tensorflow_serving_apis_get_model_status_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tensorflow_serving_apis_get_model_status_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_tensorflow_serving_apis_get_model_status_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_tensorflow_serving_apis_get_model_status_proto_msgTypes[2].Exporter = func(v any, i int) any {
