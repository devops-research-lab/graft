...
// 	protoc        v5.29.3
// source: tensorflow/serving/apis/prediction_log.proto
...
func (x *PredictionLog) GetLogType() isPredictionLog_LogType {
	if x != nil {
		return x.LogType
	}
	return nil
...
func (x *PredictionLog) GetClassifyLog() *ClassifyLog {
	if x != nil {
		if x, ok := x.LogType.(*PredictionLog_ClassifyLog); ok {
...
func (x *PredictionLog) GetRegressLog() *RegressLog {
	if x != nil {
		if x, ok := x.LogType.(*PredictionLog_RegressLog); ok {
			return x.RegressLog
		}
	}
	return nil
...
func (x *PredictionLog) GetPredictLog() *PredictLog {
	if x != nil {
		if x, ok := x.LogType.(*PredictionLog_PredictLog); ok {
			return x.PredictLog
		}
	}
	return nil
...
func (x *PredictionLog) GetPredictStreamedLog() *PredictStreamedLog {
	if x != nil {
		if x, ok := x.LogType.(*PredictionLog_PredictStreamedLog); ok {
...
func (x *PredictionLog) GetMultiInferenceLog() *MultiInferenceLog {
	if x != nil {
		if x, ok := x.LogType.(*PredictionLog_MultiInferenceLog); ok {
...
func (x *PredictionLog) GetSessionRunLog() *SessionRunLog {
	if x != nil {
		if x, ok := x.LogType.(*PredictionLog_SessionRunLog); ok {
...
var file_tensorflow_serving_apis_prediction_log_proto_rawDesc = string([]byte{
	0x0a, 0x2c, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72,
	...
	0x6e, 0x67, 0x1a, 0x2c, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73,
	...
	0x1a, 0x27, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72,
	...
	,
...
var (
	...
	file_tensorflow_serving_apis_prediction_log_proto_rawDescData []byte
)
...
func file_tensorflow_serving_apis_prediction_log_proto_rawDescGZIP() []byte {
	file_tensorflow_serving_apis_prediction_log_proto_rawDescOnce.Do(func() {
		file_tensorflow_serving_apis_prediction_log_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_serving_apis_prediction_log_proto_rawDesc), len(file_tensorflow_serving_apis_prediction_log_proto_rawDesc)))
	})
...
var file_tensorflow_serving_apis_prediction_log_proto_goTypes = []any{
...
func file_tensorflow_serving_apis_prediction_log_proto_init() {
	...
	file_tensorflow_serving_apis_prediction_log_proto_msgTypes[6].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_serving_apis_prediction_log_proto_rawDesc), len(file_tensorflow_serving_apis_prediction_log_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
