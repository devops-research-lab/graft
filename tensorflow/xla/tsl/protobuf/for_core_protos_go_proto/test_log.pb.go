...
func (x *EntryValue) GetKind() isEntryValue_Kind {
	if x != nil {
		return x.Kind
	}
	return nil
...
func (x *EntryValue) GetDoubleValue() float64 {
	if x != nil {
		if x, ok := x.Kind.(*EntryValue_DoubleValue); ok {
...
func (x *EntryValue) GetStringValue() string {
	if x != nil {
		if x, ok := x.Kind.(*EntryValue_StringValue); ok {
...
type BenchmarkEntry struct {
	...
	Extras map[string]*EntryValue `protobuf:"bytes,6,rep,name=extras,proto3" json:"extras,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *CommitId) GetKind() isCommitId_Kind {
	if x != nil {
		return x.Kind
	}
	return nil
...
func (x *CommitId) GetChangelist() int64 {
	if x != nil {
		if x, ok := x.Kind.(*CommitId_Changelist); ok {
			return x.Changelist
		}
	}
	return 0
...
func (x *CommitId) GetHash() string {
	if x != nil {
		if x, ok := x.Kind.(*CommitId_Hash); ok {
			return x.Hash
		}
	}
	return ""
...
type CPUInfo struct {
	...
	CacheSize     map[string]int64 `protobuf:"bytes,6,rep,name=cache_size,json=cacheSize,proto3" json:"cache_size,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_xla_tsl_protobuf_test_log_proto_rawDesc = string([]byte{
	...
	0x48, 0x4d, 0x41, 0x52, 0x4b, 0x10, 0x05, 0x42, 0x8b, 0x01, 0x0a, 0x1b, 0x6f, 0x72, 0x67, 0x2e,
	...
	0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x67, 0x6f, 0x2f, 0x78, 0x6c, 0x61, 0x2f, 0x74, 0x73, 0x6c,
...
var (
	...
	file_xla_tsl_protobuf_test_log_proto_rawDescData []byte
)

func file_xla_tsl_protobuf_test_log_proto_rawDescGZIP() []byte {
	file_xla_tsl_protobuf_test_log_proto_rawDescOnce.Do(func() {
		file_xla_tsl_protobuf_test_log_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_xla_tsl_protobuf_test_log_proto_rawDesc), len(file_xla_tsl_protobuf_test_log_proto_rawDesc)))
	})
...
func file_xla_tsl_protobuf_test_log_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_xla_tsl_protobuf_test_log_proto_rawDesc), len(file_xla_tsl_protobuf_test_log_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   0,
