...
var file_tensorflow_core_profiler_profiler_options_proto_rawDesc = string([]byte{
...
var file_tensorflow_core_profiler_profiler_options_proto_goTypes = []any{}
...
func file_tensorflow_core_profiler_profiler_options_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_core_profiler_profiler_options_proto_rawDesc), len(file_tensorflow_core_profiler_profiler_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
