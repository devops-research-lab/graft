...
func (x *FeatureConfiguration) GetConfig() isFeatureConfiguration_Config {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *FeatureConfiguration) GetFixedLenFeature() *FixedLenFeatureProto {
	if x != nil {
		if x, ok := x.Config.(*FeatureConfiguration_FixedLenFeature); ok {
...
func (x *FeatureConfiguration) GetVarLenFeature() *VarLenFeatureProto {
	if x != nil {
		if x, ok := x.Config.(*FeatureConfiguration_VarLenFeature); ok {
...
type ExampleParserConfiguration struct {
	state         protoimpl.MessageState           `protogen:"open.v1"`
	FeatureMap    map[string]*FeatureConfiguration `protobuf:"bytes,1,rep,name=feature_map,json=featureMap,proto3" json:"feature_map,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_tensorflow_core_example_example_parser_configuration_proto_rawDesc = string([]byte{
...
var (
	...
	file_tensorflow_core_example_example_parser_configuration_proto_rawDescData []byte
)
...
func file_tensorflow_core_example_example_parser_configuration_proto_rawDescGZIP() []byte {
	file_tensorflow_core_example_example_parser_configuration_proto_rawDescOnce.Do(func() {
		file_tensorflow_core_example_example_parser_configuration_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_core_example_example_parser_configuration_proto_rawDesc), len(file_tensorflow_core_example_example_parser_configuration_proto_rawDesc)))
	})
...
var file_tensorflow_core_example_example_parser_configuration_proto_goTypes = []any{
...
func file_tensorflow_core_example_example_parser_configuration_proto_init() {
	...
	file_tensorflow_core_example_example_parser_configuration_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_core_example_example_parser_configuration_proto_rawDesc), len(file_tensorflow_core_example_example_parser_configuration_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
