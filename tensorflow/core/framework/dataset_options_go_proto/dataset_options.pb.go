...
type ServiceOptions struct {
	...
	//
	// Types that are assignable to OptionalPinned:
	//
...
func (m *ServiceOptions) GetOptionalPinned() isServiceOptions_OptionalPinned {
	if m != nil {
		return m.OptionalPinned
	}
	return nil
}

func (x *ServiceOptions) GetPinned() bool {
	if x, ok := x.GetOptionalPinned().(*ServiceOptions_Pinned); ok {
		return x.Pinned
	}
	return false
}
...
func file_tensorflow_core_framework_dataset_options_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tensorflow_core_framework_dataset_options_proto_msgTypes[6].Exporter = func(v any, i int) any {
