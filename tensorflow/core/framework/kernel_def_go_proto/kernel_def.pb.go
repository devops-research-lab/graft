...
func file_tensorflow_core_framework_kernel_def_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tensorflow_core_framework_kernel_def_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_tensorflow_core_framework_kernel_def_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_tensorflow_core_framework_kernel_def_proto_msgTypes[2].Exporter = func(v any, i int) any {
