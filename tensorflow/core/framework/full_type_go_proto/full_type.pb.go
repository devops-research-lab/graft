...
func (x *FullTypeDef) GetAttr() isFullTypeDef_Attr {
	if x != nil {
		return x.Attr
	}
	return nil
...
func (x *FullTypeDef) GetS() string {
	if x != nil {
		if x, ok := x.Attr.(*FullTypeDef_S); ok {
			return x.S
		}
	}
	return ""
...
func (x *FullTypeDef) GetI() int64 {
	if x != nil {
		if x, ok := x.Attr.(*FullTypeDef_I); ok {
			return x.I
		}
	}
	return 0
...
var file_tensorflow_core_framework_full_type_proto_rawDesc = string([]byte{
...
var (
	...
	file_tensorflow_core_framework_full_type_proto_rawDescData []byte
)
...
func file_tensorflow_core_framework_full_type_proto_rawDescGZIP() []byte {
	file_tensorflow_core_framework_full_type_proto_rawDescOnce.Do(func() {
		file_tensorflow_core_framework_full_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_core_framework_full_type_proto_rawDesc), len(file_tensorflow_core_framework_full_type_proto_rawDesc)))
	})
...
func file_tensorflow_core_framework_full_type_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_core_framework_full_type_proto_rawDesc), len(file_tensorflow_core_framework_full_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
