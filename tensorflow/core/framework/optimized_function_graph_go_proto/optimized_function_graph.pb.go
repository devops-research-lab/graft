...
type OptimizedFunctionGraph struct {
	...
	// bridge.
	NodeNameToControlRet map[string]string `protobuf:"bytes,3,rep,name=node_name_to_control_ret,json=nodeNameToControlRet,proto3" json:"node_name_to_control_ret,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
var file_tensorflow_core_framework_optimized_function_graph_proto_rawDesc = string([]byte{
...
var (
	...
	file_tensorflow_core_framework_optimized_function_graph_proto_rawDescData []byte
)
...
func file_tensorflow_core_framework_optimized_function_graph_proto_rawDescGZIP() []byte {
	file_tensorflow_core_framework_optimized_function_graph_proto_rawDescOnce.Do(func() {
		file_tensorflow_core_framework_optimized_function_graph_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_core_framework_optimized_function_graph_proto_rawDesc), len(file_tensorflow_core_framework_optimized_function_graph_proto_rawDesc)))
	})
...
var file_tensorflow_core_framework_optimized_function_graph_proto_goTypes = []any{
...
func file_tensorflow_core_framework_optimized_function_graph_proto_init() {
	...
	file_tensorflow_core_framework_optimized_function_graph_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_core_framework_optimized_function_graph_proto_rawDesc), len(file_tensorflow_core_framework_optimized_function_graph_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
