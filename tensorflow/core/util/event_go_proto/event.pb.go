...
func (x *Event) GetWhat() isEvent_What {
	if x != nil {
		return x.What
	}
	return nil
...
func (x *Event) GetFileVersion() string {
	if x != nil {
		if x, ok := x.What.(*Event_FileVersion); ok {
...
func (x *Event) GetGraphDef() []byte {
	if x != nil {
		if x, ok := x.What.(*Event_GraphDef); ok {
			return x.GraphDef
		}
	}
	return nil
...
func (x *Event) GetSummary() *summary_go_proto.Summary {
	if x != nil {
		if x, ok := x.What.(*Event_Summary); ok {
			return x.Summary
		}
	}
	return nil
...
func (x *Event) GetLogMessage() *LogMessage {
	if x != nil {
		if x, ok := x.What.(*Event_LogMessage); ok {
			return x.LogMessage
		}
	}
	return nil
...
func (x *Event) GetSessionLog() *SessionLog {
	if x != nil {
		if x, ok := x.What.(*Event_SessionLog); ok {
			return x.SessionLog
		}
	}
	return nil
...
func (x *Event) GetTaggedRunMetadata() *TaggedRunMetadata {
	if x != nil {
		if x, ok := x.What.(*Event_TaggedRunMetadata); ok {
...
func (x *Event) GetMetaGraphDef() []byte {
	if x != nil {
		if x, ok := x.What.(*Event_MetaGraphDef); ok {
...
var file_tensorflow_core_util_event_proto_rawDesc = string([]byte{
...
var (
	...
	file_tensorflow_core_util_event_proto_rawDescData []byte
)

func file_tensorflow_core_util_event_proto_rawDescGZIP() []byte {
	file_tensorflow_core_util_event_proto_rawDescOnce.Do(func() {
		file_tensorflow_core_util_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_core_util_event_proto_rawDesc), len(file_tensorflow_core_util_event_proto_rawDesc)))
	})
...
var file_tensorflow_core_util_event_proto_goTypes = []any{
...
func file_tensorflow_core_util_event_proto_init() {
	...
	file_tensorflow_core_util_event_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_core_util_event_proto_rawDesc), len(file_tensorflow_core_util_event_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
