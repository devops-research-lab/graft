...
var file_tensorflow_core_util_quantization_uniform_quant_ops_attr_proto_rawDesc = string([]byte{
...
var (
	...
	file_tensorflow_core_util_quantization_uniform_quant_ops_attr_proto_rawDescData []byte
)
...
func file_tensorflow_core_util_quantization_uniform_quant_ops_attr_proto_rawDescGZIP() []byte {
	file_tensorflow_core_util_quantization_uniform_quant_ops_attr_proto_rawDescOnce.Do(func() {
		file_tensorflow_core_util_quantization_uniform_quant_ops_attr_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_core_util_quantization_uniform_quant_ops_attr_proto_rawDesc), len(file_tensorflow_core_util_quantization_uniform_quant_ops_attr_proto_rawDesc)))
	})
...
func file_tensorflow_core_util_quantization_uniform_quant_ops_attr_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_core_util_quantization_uniform_quant_ops_attr_proto_rawDesc), len(file_tensorflow_core_util_quantization_uniform_quant_ops_attr_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
