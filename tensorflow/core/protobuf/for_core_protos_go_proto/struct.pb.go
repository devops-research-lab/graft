...
func (x *StructuredValue) GetTensorValue() *tensor_go_proto.TensorProto {
	if x != nil {
		if x, ok := x.Kind.(*StructuredValue_TensorValue); ok {
...
func (x *StructuredValue) GetNumpyValue() *tensor_go_proto.TensorProto {
	if x != nil {
		if x, ok := x.Kind.(*StructuredValue_NumpyValue); ok {
			return x.NumpyValue
		}
	}
	return nil
...
var file_tensorflow_core_protobuf_struct_proto_rawDesc = string([]byte{
