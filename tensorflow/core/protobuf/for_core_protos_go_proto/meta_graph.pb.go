...
type SignatureDef struct {
	...
	Defaults      map[string]*tensor_go_proto.TensorProto `protobuf:"bytes,4,rep,name=defaults,proto3" json:"defaults,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_tensorflow_core_protobuf_meta_graph_proto_rawDesc = string([]byte{
