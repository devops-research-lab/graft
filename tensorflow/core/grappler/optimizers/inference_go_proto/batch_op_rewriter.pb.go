...
var file_tensorflow_core_grappler_optimizers_inference_batch_op_rewriter_proto_rawDesc = string([]byte{
...
var (
	...
	file_tensorflow_core_grappler_optimizers_inference_batch_op_rewriter_proto_rawDescData []byte
)
...
func file_tensorflow_core_grappler_optimizers_inference_batch_op_rewriter_proto_rawDescGZIP() []byte {
	file_tensorflow_core_grappler_optimizers_inference_batch_op_rewriter_proto_rawDescOnce.Do(func() {
		file_tensorflow_core_grappler_optimizers_inference_batch_op_rewriter_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_core_grappler_optimizers_inference_batch_op_rewriter_proto_rawDesc), len(file_tensorflow_core_grappler_optimizers_inference_batch_op_rewriter_proto_rawDesc)))
	})
...
func file_tensorflow_core_grappler_optimizers_inference_batch_op_rewriter_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_core_grappler_optimizers_inference_batch_op_rewriter_proto_rawDesc), len(file_tensorflow_core_grappler_optimizers_inference_batch_op_rewriter_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
