...
func file_tensorflow_core_grappler_optimizers_inference_batch_op_rewriter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tensorflow_core_grappler_optimizers_inference_batch_op_rewriter_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_tensorflow_core_grappler_optimizers_inference_batch_op_rewriter_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_tensorflow_core_grappler_optimizers_inference_batch_op_rewriter_proto_msgTypes[3].Exporter = func(v any, i int) any {
