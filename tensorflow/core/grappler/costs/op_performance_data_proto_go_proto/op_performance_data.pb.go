...
type OpInfo struct {
	...
	Attr   map[string]*attr_value_go_proto.AttrValue `protobuf:"bytes,2,rep,name=attr,proto3" json:"attr,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *OpPerformance) GetExecutionTime() isOpPerformance_ExecutionTime {
	if x != nil {
...
func (x *OpPerformance) GetExecutionTimeNormal() *NormalDistribution {
	if x != nil {
		if x, ok := x.ExecutionTime.(*OpPerformance_ExecutionTimeNormal); ok {
...
func (x *OpPerformance) GetExecutionTimeLogNormal() *LogNormalDistribution {
	if x != nil {
		if x, ok := x.ExecutionTime.(*OpPerformance_ExecutionTimeLogNormal); ok {
...
var file_tensorflow_core_grappler_costs_op_performance_data_proto_rawDesc = string([]byte{
...
var (
	...
	file_tensorflow_core_grappler_costs_op_performance_data_proto_rawDescData []byte
)
...
func file_tensorflow_core_grappler_costs_op_performance_data_proto_rawDescGZIP() []byte {
	file_tensorflow_core_grappler_costs_op_performance_data_proto_rawDescOnce.Do(func() {
		file_tensorflow_core_grappler_costs_op_performance_data_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tensorflow_core_grappler_costs_op_performance_data_proto_rawDesc), len(file_tensorflow_core_grappler_costs_op_performance_data_proto_rawDesc)))
	})
...
var file_tensorflow_core_grappler_costs_op_performance_data_proto_goTypes = []any{
...
func file_tensorflow_core_grappler_costs_op_performance_data_proto_init() {
	...
	file_tensorflow_core_grappler_costs_op_performance_data_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tensorflow_core_grappler_costs_op_performance_data_proto_rawDesc), len(file_tensorflow_core_grappler_costs_op_performance_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
