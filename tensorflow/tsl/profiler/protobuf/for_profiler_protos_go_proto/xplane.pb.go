...
type XPlane struct {
	...
	EventMetadata map[int64]*XEventMetadata `protobuf:"bytes,4,rep,name=event_metadata,json=eventMetadata,proto3" json:"event_metadata,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	StatMetadata map[int64]*XStatMetadata `protobuf:"bytes,5,rep,name=stat_metadata,json=statMetadata,proto3" json:"stat_metadata,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *XEvent) GetData() isXEvent_Data {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *XEvent) GetOffsetPs() int64 {
	if x != nil {
		if x, ok := x.Data.(*XEvent_OffsetPs); ok {
			return x.OffsetPs
		}
	}
	return 0
...
func (x *XEvent) GetNumOccurrences() int64 {
	if x != nil {
		if x, ok := x.Data.(*XEvent_NumOccurrences); ok {
...
func (x *XStat) GetValue() isXStat_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *XStat) GetDoubleValue() float64 {
	if x != nil {
		if x, ok := x.Value.(*XStat_DoubleValue); ok {
...
func (x *XStat) GetUint64Value() uint64 {
	if x != nil {
		if x, ok := x.Value.(*XStat_Uint64Value); ok {
...
func (x *XStat) GetInt64Value() int64 {
	if x != nil {
		if x, ok := x.Value.(*XStat_Int64Value); ok {
			return x.Int64Value
		}
	}
	return 0
...
func (x *XStat) GetStrValue() string {
	if x != nil {
		if x, ok := x.Value.(*XStat_StrValue); ok {
			return x.StrValue
		}
	}
	return ""
...
func (x *XStat) GetBytesValue() []byte {
	if x != nil {
		if x, ok := x.Value.(*XStat_BytesValue); ok {
			return x.BytesValue
		}
	}
	return nil
...
func (x *XStat) GetRefValue() uint64 {
	if x != nil {
		if x, ok := x.Value.(*XStat_RefValue); ok {
			return x.RefValue
		}
	}
	return 0
...
var file_tsl_profiler_protobuf_xplane_proto_rawDesc = string([]byte{
...
var (
	...
	file_tsl_profiler_protobuf_xplane_proto_rawDescData []byte
)

func file_tsl_profiler_protobuf_xplane_proto_rawDescGZIP() []byte {
	file_tsl_profiler_protobuf_xplane_proto_rawDescOnce.Do(func() {
		file_tsl_profiler_protobuf_xplane_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tsl_profiler_protobuf_xplane_proto_rawDesc), len(file_tsl_profiler_protobuf_xplane_proto_rawDesc)))
	})
...
var file_tsl_profiler_protobuf_xplane_proto_goTypes = []any{
...
func file_tsl_profiler_protobuf_xplane_proto_init() {
	...
	file_tsl_profiler_protobuf_xplane_proto_msgTypes[3].OneofWrappers = []any{
		(*XEvent_OffsetPs)(nil),
		(*XEvent_NumOccurrences)(nil),
	}
	file_tsl_profiler_protobuf_xplane_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tsl_profiler_protobuf_xplane_proto_rawDesc), len(file_tsl_profiler_protobuf_xplane_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
